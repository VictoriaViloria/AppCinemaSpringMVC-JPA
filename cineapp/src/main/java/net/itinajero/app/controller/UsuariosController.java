...
public class UsuariosController {
	...
	@PostMapping("/save")
	public String guardar(@ModelAttribute Usuario usuario,@RequestParam("perfil") String perfil) {//este ultimo perfil cacha lo que trae @RequestParam("perfil") 
		System.out.println("Usuario: "+usuario);//para ver que si llega el usuario cachado en el formulario
